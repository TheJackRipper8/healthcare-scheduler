...
import { useAuth } from "../auth/AuthContext";
  export default function StaffCompletedAppointmentsPage() {
  const { user } = useAuth();
  ...
  useEffect(() => {
    ...
    async function loadToday() 
    {
      try 
      {
        ...
        let scope = "staff";
        const res = await fetch(`/api/get-staff-completed-appointment?scope=${scope}`, {//fetch(`/api/get-staff-completed-appointment?selectedDate=${selectedDate}&scope=${scope}`, {
          method: "GET",
          headers: {
